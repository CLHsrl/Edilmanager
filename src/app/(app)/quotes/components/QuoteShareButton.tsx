...
export default function QuoteShareButton({ quoteNumber, clientEmail }: { quoteNumber: string | number, clientEmail?: string | null }) {
  return (
    <button 
      ...
      className="flex-1 py-3 bg-gray-50 hover:bg-blue-600 hover:text-white rounded-xl text-[10px] font-bold uppercase tracking-wide text-gray-400 transition-all flex items-center justify-center gap-2"
    >
      Invia al Cliente
    </button>
  );
