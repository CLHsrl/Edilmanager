        ...
        <div className="min-h-screen bg-slate-50 print:bg-white pb-20">
            ...
            <div className="bg-white border-b border-slate-100 p-6 flex justify-between items-center print:hidden sticky top-0 z-50">
                ...
                <div className="flex items-center gap-4">
                    <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wide">Ottimizzato per stampa A4</p>
                    <button 
                        onClick={() => window.print()}
                        className="bg-slate-900 text-white px-8 py-3 rounded-xl flex items-center gap-3 text-[10px] font-bold uppercase tracking-wide shadow-xl hover:bg-blue-600 transition-all active:scale-95"
                    >
            ...
            <div className="max-w-[1000px] mx-auto bg-white my-10 print:my-0 shadow-2xl print:shadow-none p-16 md:p-24 min-h-[1414px]">
                ...
                <header className="mb-24 flex justify-between items-start">
                    <div>
                        <div className="flex items-center gap-4 mb-6">
                            ...
                            <div>
                                <h1 className="text-4xl font-bold text-slate-900 tracking-tighter uppercase leading-none">EdilManager</h1>
                                <p className="text-[10px] font-bold text-blue-600 uppercase tracking-wide mt-1 italic">Enterprise 2.0</p>
                            </div>
                        </div>
                        <h2 className="text-5xl font-bold text-slate-900 tracking-tighter uppercase leading-tight max-w-xl">
                            Analisi Tecnologica e Controllo dei Margini Aziendali
                        </h2>
                    </div>
                    <div className="text-right">
                        <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wide mb-2">Data Documento</p>
                        <p className="text-lg font-bold text-slate-900">{new Date().toLocaleDateString('it-IT', { day: 'numeric', month: 'long', year: 'numeric' })}</p>
                    </div>
                </header>
                ...
                <section className="mb-32 break-inside-avoid">
                    <div className="flex items-center gap-3 mb-8">
                        ...
                        <h3 className="text-xl font-bold text-slate-900 uppercase tracking-wide">01. Supervisione Direzionale</h3>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                        <div>
                            <p className="text-[10px] font-bold text-blue-600 uppercase tracking-wide mb-4">Trasparenza Totale</p>
                        ...
                        <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100">
                            <ul className="space-y-4">
                                <li className="flex items-center gap-3 text-[10px] font-bold text-slate-500 uppercase tracking-wide">
                ...
                <section className="mb-32 break-inside-avoid">
                    <div className="flex items-center gap-3 mb-8">
                        ...
                        <h3 className="text-xl font-bold text-slate-900 uppercase tracking-wide">02. Controllo Commesse</h3>
                    </div>
                    <div className="bg-slate-50 rounded-[2.5rem] border border-slate-100 p-2 mb-8 overflow-hidden shadow-inner">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                        <div>
                            <p className="text-[10px] font-bold text-blue-600 uppercase tracking-wide mb-4">Ottimizzazione Risorse</p>
                            <p className="text-sm text-slate-600 leading-relaxed font-medium">
                ...
                <section className="mb-32 break-inside-avoid">
                    <div className="flex items-center gap-3 mb-8">
                        ...
                        <h3 className="text-xl font-bold text-slate-900 uppercase tracking-wide">03. Liquidità e Bilancio</h3>
                    </div>
                    <div className="bg-slate-50 rounded-[2.5rem] border border-slate-100 p-2 mb-8 overflow-hidden shadow-inner">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                        <div>
                            <p className="text-[10px] font-bold text-blue-600 uppercase tracking-wide mb-4">Automazione Contabile</p>
                            <p className="text-sm text-slate-600 leading-relaxed font-medium">
                ...
                <section className="mb-32 break-inside-avoid">
                    <div className="flex items-center gap-3 mb-8">
                        ...
                        <h3 className="text-xl font-bold text-slate-900 uppercase tracking-wide">04. Gestione Asset</h3>
                    </div>
                    <div className="bg-slate-50 rounded-[2.5rem] border border-slate-100 p-2 mb-8 overflow-hidden shadow-inner">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                        <div>
                            <p className="text-[10px] font-bold text-blue-600 uppercase tracking-wide mb-4">Valore del Patrimonio</p>
                            <p className="text-sm text-slate-600 leading-relaxed font-medium">
                ...
                <footer className="mt-48 pt-16 border-t border-slate-100 flex justify-between items-end">
                    <div>
                        <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wide mb-4">Documentazione Riservata</p>
                        <p className="text-xs font-bold text-slate-900">EdilManager Enterprise Solution - P.IVA 0123456789</p>
                    </div>
                    <div className="text-right">
                        <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wide">Pagina di Analisi</p>
                        <p className="text-2xl font-bold text-slate-900">Enterprise Ready</p>
                    </div>
                </footer>
            </div>
